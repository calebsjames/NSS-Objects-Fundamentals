...
// example: "title": "Ten"
for (thing in tenAlbum) {
    console.log(tenAlbum[thing])
}
...
for (let song of tenAlbum.tracks) {
...
// .keys()
for (key of Object.keys(tenAlbum)) {
    console.log(key)
}

// .values()
for (value of Object.values(tenAlbum)) {
    console.log(value)
}

// .entries()
for (entry of Object.entries(tenAlbum)) {
    console.log(entry)
}
